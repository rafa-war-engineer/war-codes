...
wifiData1 wifiSetup(char wifiList[40][40], uint8_t wifiNoT){
        //wifiData1 wifiData_to_main;  //Ursprüngliche
        ...
        case 2:
                ...
                if(slotNo>8) {
                        ...
                        else if (millis()-oldTime_ms>10000||wifiData_to_main.wifiNameNo_for_main==wifiNoT) {
                                //Serial.println("en Caso 2  wifisetup");
                                wifiCaseVar=6;
                                wifiData_to_main.wifiNameNo_for_main=wifiNoT;
                                if(millis()-oldTime_ms>10000) {
                                        wifiData_to_main.wifiTimeOut = HIGH;
                                        //Serial.println("Timeout reached" + String(wifiData_to_main.wifiTimeOut));
                                }
                        }
                }
                break;
